...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows == 1) {
        ...
        if (password_verify($password, $hashed_password)) {
            ...
            header("Location: ../Arabic/ar_home1.php");
            exit();
        } else {
...
<!--  <section id="topbar" class="d-flex align-items-center">
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="../ar_index.php">Artificial Bin System</a></h1>
...
<section id="hero">
    ...
    <div class="container">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <input type="email" id="email" name="email" placeholder="أدخل البريد الإلكتروني" required><br>
            <label for="password">كلمة المرور:</label>
            <input type="password" id="password" name="password" placeholder="أدخل كلمة المرور" required><br>
            <a href="../Arabic/ar_signup.php">ليس لديك حساب؟ انقر هنا!</a><br><br>
